...
package meteordevelopment.meteorclient.gui.themes.example;
...
public class ExampleOtherGuiTheme extends GuiTheme {
    ...
    public ESPBlockData blockEspDefaultData() {
        return new ESPBlockData(
            ShapeMode.Both,
            new SettingColor(200, 0, 255),
            new SettingColor(200, 0, 255, 25),
            false,
            new SettingColor(200, 0, 255, 125)
        );
    }
